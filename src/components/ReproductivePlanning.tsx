      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 pt-8 border-t border-rosa-marfil-2">
          <p className="text-xs text-gray-500 italic text-center">
            <a href="https://bvsms.saude.gov.br/bvs/publicacoes/doenca_falciforme_atencao_integral_saude_mulher.pdf" target="_blank">Fonte: Ministério da Saúde. Atenção Integral à Saúde das Mulheres. Brasília: MS, 2015.</a>
          </p>
        </div>
      </div>
    </section>
