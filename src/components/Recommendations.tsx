  ...
  return (
    <section id="recomendacoes" className="py-20 bg-rosa-marfil-1">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-accent/10 to-rosa-marfil-2/50 p-8 rounded-2xl mb-16">
          <h3 className="text-2xl font-bold text-text mb-6 text-center">Considerações Finais</h3>
        ...
        <div className="pt-8 border-t border-rosa-marfil-2">
          <p className="text-xs text-gray-500 italic text-center">
            <a href="https://pubmed.ncbi.nlm.nih.gov/17197616/" target="_blank">Fonte: American College of Obstetricians and Gynecologists. Management of Sickle Cell Disease in Pregnancy. Practice Bulletin No. 78. Washington: ACOG, 2007.</a>
          </p>
        </div>
      </div>
    </section>
